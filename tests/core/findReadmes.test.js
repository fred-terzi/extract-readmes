...
// import findReadmes from '../../../src/core/findReadmes.js';
// const tmpRoot = path.join(process.cwd(), 'tests/fixtures/tmp-root');
// const readmePaths = [
//     'README.md',
//     'sub/README.md',
//     'sub/ReadMe.md',
...
//             path.join('sub', 'ReadMe.md'),
//             path.join('sub', 'hidden', '.hiddenREADME.md'),
...
//# sourceMappingURL=findReadmes.test.js.map
